<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="项目型号" width="200px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.modelid }}</span>
        </template>
      </el-table-column>
      <el-table-column label="型号数量" width="200px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.pronum }}</span>
        </template>
      </el-table-column>
      <el-table-column label="升级包数量" width="200px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.otanum }}</span>
        </template>
      </el-table-column>
      <el-table-column label="备注" width="268px" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        <el-form-item label="项目名称" prop="title" label-width="100px">
          <el-input v-model="temp.title" />
        </el-form-item>
        <el-form-item label="设备型号" prop="modelid" label-width="100px">
...
<script>
import { fetchList, fetchPv, createProject, updateArticle } from '@/api/project'
